...
- **The same vetting argument transfers to skills, for the same reason.** "All of us, we experiment with the public skills. But when you think about it, some skills may have some prompt injection, and skills actually does have scripts because that is the deterministic part of it… So if you don't have again a pipeline that check your security, you may be pulling something that is insecure." ([Touil](../sources/20260828_M05vON8i0aI.md), 12:37-12:59) A skill is action-capable on exactly the grounds an MCP server is — it carries executable content — but arrives through a lighter channel: copied from a public repo into a dotfile directory, with no server to register, no credential to issue, and often no review. If MCP servers are vetted and skills are not, the weaker path is the one attackers use. Nothing in the talk is measured.
...
- [AI-Native Organisations Run on Skills: How to Structure and Scale Them — Imad Touil, QuantumBlack](../sources/20260828_M05vON8i0aI.md), 12:37-12:59
