...
- **A same-day complement about the axis everyone else is on.** Where this page says the size axis is unavailable to *you*, Sara Hooker argues it is running out for *everyone*: "pre-training size in particular is not your most lucrative axis of scale" because "our architecture is saturated," and "no frontier AI lab is going to [supersize] their model again for pre-training" ([Adaption](../sources/20260812_XEd_SRVHBgU.md), 10:52-11:36, 18:37-19:03). The two arguments compose rather than compete, and the composition is the planning-relevant part: if the axis you cannot use is also the axis that has stopped paying, then waiting for a bigger base model is not merely slow for private-domain work — it is not the lever anywhere. Her answer for where the lever went, "instead of the size people are just moving post-training further back" (19:31-19:39), points at the same compute-on-a-fixed-corpus region this page describes. See [Pre-Training Size Is No Longer the Most Lucrative Scaling Axis](pretraining-size-is-no-longer-the-most-lucrative-scaling-axis.md).
...
- [Adaption Labs: Gradient-Free Continual Learning — Sara Hooker, Adaption](../sources/20260812_XEd_SRVHBgU.md), 10:52-11:36, 18:37-19:39
