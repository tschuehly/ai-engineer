...
- **The extreme of the amortization argument: index once, then classify everything.** Exa's internal market dashboard is built by running its web embeddings over the whole addressable market at once — "arbitrarily powerful semantic filtering and slicing and dicing of any type of data that you want" — rather than by issuing a query per account. When the index already exists for another reason, the marginal cost of an exhaustive pass is low enough that whole-corpus labelling becomes a reasonable product, which is the opposite end of the volume spectrum from the one-off discovery case. ([Wang](../sources/20260826_6pbQgnJ9Voc.md), 05:44-06:58)
...
- [Knowledge Systems: The New GTM Stack — Jeffrey Wang, Exa](../sources/20260826_6pbQgnJ9Voc.md), 05:44-06:58
