...
- **"Evals are a team sport" is corroborated verbatim, with a different answer to the accessibility problem.** DoorDash reaches the same phrase — "this is all basically a team sport. We all have to play and help improve the quality of AI" — but where this page's answer is a mature shared surface with controlled parameters, theirs is that no single surface fits: "it's almost hard for a platform team to build like a UI specific for each use case," so operators generate their own annotation apps against stable APIs. Both agree spreadsheets fail non-technical collaborators; they disagree on whether the replacement is one well-designed console or many disposable ones, and the deciding question is how many genuinely unlike annotation workflows the platform serves. ([AI Evals for Cross-Functional Teams — Nachiket Paranjape & Swaroop Chitlur Haridas, DoorDash](../sources/20260828_bMjlRrWjdT0.md), 04:01-04:33, 08:39-10:29)
...
- [AI Evals for Cross-Functional Teams — Nachiket Paranjape & Swaroop Chitlur Haridas, DoorDash](../sources/20260828_bMjlRrWjdT0.md), 04:01-04:33, 08:39-10:29
