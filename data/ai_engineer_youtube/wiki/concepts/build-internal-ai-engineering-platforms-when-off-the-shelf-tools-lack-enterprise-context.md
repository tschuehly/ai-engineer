...
- **Demand heterogeneity as the build justification, and existing infrastructure as the cost control.** DoorDash's internal eval platform exists because three teams wanted incompatible things — "session level quality judgments" for the shopping assistant, "a way to scale up human judgment" for personalization ML, "trajectory based evals" for multi-agent systems — framed as the question "how do you cater to all these different needs under a common platform." What kept the build affordable was not building most of it: "we're trying to reuse a lot of the existing infrastructure that already existed at DoorDash, and that's helped us get a long way." ([AI Evals for Cross-Functional Teams — Nachiket Paranjape & Swaroop Chitlur Haridas, DoorDash](../sources/20260828_bMjlRrWjdT0.md), 02:11-02:50, 13:36-13:58)
...
- [AI Evals for Cross-Functional Teams — Nachiket Paranjape & Swaroop Chitlur Haridas, DoorDash](../sources/20260828_bMjlRrWjdT0.md), 02:11-02:50, 13:36-13:58
