...
- **The tradeoff flagged above as inference now has a source, and it comes with an ordering.** Rosenthal ran the enterprise side of OpenAI through exactly this decision and reports the sequencing error: the enterprise tier shipped first, self-serve four months later, and "it just completely cannibalized our enterprise business… It turns out most people just didn't want to talk to a salesperson." Her corrected rule is not that self-serve coexists with the sales motion but that it precedes it — "we should have launched with self-serve first, listen to feedback from our customers and what they weren't getting from the self-serve product, and then figured out how to build a more expensive enterprise offering, and then hire the team to sell it." That is the same conclusion this page reaches from the agent's side, arrived at three years earlier and for human buyers, which is some evidence that the agent channel is amplifying a pre-existing preference rather than creating one. See [Ship Self-Serve Before the Enterprise Tier](ship-self-serve-before-the-enterprise-tier.md). ([Rosenthal](../sources/20260826_wdTRsfw0KG0.md), 02:59-04:14)
...
- [Reverse-Engineering the AI Buyer — Aliisa Rosenthal, Acrew Capital](../sources/20260826_wdTRsfw0KG0.md), 02:59-04:14
