...
- **The cross-team alignment cost is the plan's real price, and it is paid into the same artifact the agent executes.** "In the pre-AI world, this plan probably worked in that for a week. I aligned with… three other teams for another week on that, and then I just sent it to an agent to implement overnight, and it came back." One document carries both jobs, which is what makes a second week of alignment defensible — but it also means every phase detailed enough to hand to a subagent is a phase three other teams had to read and agree to. The compression is in implementation time; the coordination time is unchanged. ([Blum](../sources/20260828_5Bn0xro2ol8.md), 08:07-08:26, 11:14-11:35)
...
- [How to Get Your Org to Adopt Coding Agents (Without Shipping Garbage) — Eyal Blum, Figma](../sources/20260828_5Bn0xro2ol8.md), 08:07-08:26, 11:14-11:35
