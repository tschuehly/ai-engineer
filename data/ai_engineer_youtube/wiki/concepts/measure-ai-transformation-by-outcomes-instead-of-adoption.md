...
- **Two process metrics for the gap between outcome reviews, chosen for attributability rather than importance.** Debois dismisses token spend and license counts and proposes human touches to a correct result, which should fall as harness and context improve, plus how much of each fix is shared. His argument is explicitly about what a VP can defend: "we have faster delivery, maybe they can promise, but hard to prove. We have quality that improved, again, hard to say. But… you can show how much turns and how much improvement you're making on that journey. And same thing, how much there is reuse." Neither metric is an outcome and he does not claim otherwise — the point is that a delivery-speed comparison needs a counterfactual nobody has, while both of these move in response to the enablement work itself. Neither is operationally defined and neither is reported with a value anywhere in the talk. See [Measure Enablement by Human Touches and Share of Fixes Reused](measure-enablement-by-human-touches-and-share-of-fixes-reused.md). ([Debois](../sources/20260822_zCJtYuqwm7E.md), 09:09-10:19, 17:32-18:19)
...
- [Coding Agents Don't Scale Themselves. Neither Do Your Teams. — Patrick Debois, Tessl](../sources/20260822_zCJtYuqwm7E.md), 09:09-10:19, 17:32-18:19
