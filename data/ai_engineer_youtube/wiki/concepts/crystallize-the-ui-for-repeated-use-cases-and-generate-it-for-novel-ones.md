...
- **Both halves visible in one internal stack.** Ramp funnels campaign intent into "Ramp Revenue, the internal application that we have built" — a crystallized surface for the repeated motion — while employees who want something the application does not cover connect their own agents to the internal MCP server and build it themselves. The second path is not a lesser fallback here but the discovery mechanism for the first: what people repeatedly build for themselves is what earns a frozen interface next ([Read Employee-Built Automations as the Productionization Backlog](read-employee-built-automations-as-the-productionization-backlog.md)). ([Vaziri](../sources/20260826_VjEP0xqTUI0.md), 14:11-15:28, 16:29-16:38)
...
- [The Building Blocks of GTM Orchestration — Arman Vaziri, Ramp](../sources/20260826_VjEP0xqTUI0.md), 14:11-15:28, 16:29-16:38
