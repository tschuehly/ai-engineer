...
- **Attention scarcity now shows up in prose volume, not only in agent supervision.** "All of a sudden all the design docs and all the Slack messages… the emails have gotten three or four times as long and we've gotten two or three times as many emails and they say basically as much as they did before… some of the markers of like what is high quality and important things versus not so much high quality… has become challenging to navigate." Length used to be a weak proxy for effort and therefore for importance; generation broke the correlation without supplying a replacement. The counter Blum proposes is not another delegation layer but a labelling convention — say which lines a human typed, so the reader knows where to concentrate. The multipliers are impressions rather than counts. ([Blum](../sources/20260828_5Bn0xro2ol8.md), 04:08-04:42, 12:45-13:37)

- **The step before attention becomes the constraint, and the bill that arrives when you take it.** Liguori's account puts a prior bottleneck in front of this one: an engineer in a conversational loop is not attention-limited but *serialization*-limited, sitting through "30 seconds to a minute" per turn and therefore unable to occupy a second loop at all. Attention only becomes the binding constraint once the loop is escaped — and the escape is immediately expensive: "the cognitive load increases as you run these multiple agents in parallel. You're constantly shifting between terminal tabs," alongside engineers "staying up late late at night trying to get that perfect prompt that's going to make their agent run for hours overnight so that they wake up in the morning with a code change ready." She credits the burnout term to another speaker and the captions do not recover it. She also reports the load falling unevenly: "reviewing AI output is often harder for some than actually writing it, especially early in career," because senior engineers "have already spent a large portion of their career reviewing others code" and "early career engineers don't have that muscle yet." All three are observations with no survey, hours, or attrition data. ([Liguori](../sources/20260828_pqlWNihgdjI.md), 11:21-11:58, 15:43-16:44)
...
- [How to Get Your Org to Adopt Coding Agents (Without Shipping Garbage) — Eyal Blum, Figma](../sources/20260828_5Bn0xro2ol8.md), 04:08-04:42, 12:45-13:37
- [From AI-Assisted to AI-Native: Building a Frontier Development Team — Clare Liguori, AWS](../sources/20260828_pqlWNihgdjI.md), 11:21-11:58, 15:43-16:44
