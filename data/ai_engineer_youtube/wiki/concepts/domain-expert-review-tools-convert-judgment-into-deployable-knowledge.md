...
- **The minimum viable version, and what it must not throw away.** Before any of this tooling exists, the artifact worth building is a comment box on real outputs: "you put real outputs in front of your experts. Clinicians spend a focused few hours leaving comments. A session doesn't have to be a month-long labeling project to start with." Two design points survive into the mature tool. Collect "not just a score, but the reasoning and corrections," because the judgment being captured is *which* difference mattered here, and a rating erases exactly that. And keep the input free-form at the start — a structured form can only collect dimensions someone already named, which is the same limit that defeats a pre-written rubric. Fox's closing advice is this step alone: "the easiest place to start is your experts leaving free-form comments on real outputs. That's the raw material for everything else." See [Capture Expert Reasoning and Corrections, Not Just a Score](capture-expert-reasoning-and-corrections-not-just-a-score.md). ([Fox](../sources/20260822_yqF6XhzbWBk.md), 14:39-15:18, 18:31-18:52)
...
- [Inside 847 Production Clinical AI Notes — Sebastian Fox, Composo](../sources/20260822_yqF6XhzbWBk.md), 14:39-15:18, 18:31-18:52
