...
- **A cost this page's framing does not capture, plus an audience where the sign flips.** Jarmak reports a penalty charged on recognition rather than on quality: developers reject content they identify as model-written — "not using Claude's slop at them… tell your AEs to stop that as well. Nobody… everybody knows what it is and nobody likes it." That is a signaling cost attached to recognizable cadence, which a quality-only axis has no place for; the reconciliation is to fix the cadence rather than conceal the provenance. The sign then flips for the other reader: "Claude loves its own slop… there's a bias, right, from agents of their own content," so agent-facing material "as long as it's structured" pays no such penalty. Two audiences, opposite rules. See [Human and Agent Credibility Reward Opposite Writing Styles](human-and-agent-credibility-reward-opposite-writing-styles.md). ([Jarmak](../sources/20260826_Lrw0jqBNaw0.md), 16:20-16:45)
