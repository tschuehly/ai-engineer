...
- **The case where consolidation is not available, and what the orchestrator has to absorb instead.** Berry assumes the ten to thirty tools stay where they are, because they belong to different teams and sync to each other on their own schedules: "the view of the world that those tools have is different depending on where you look. And so, orchestration, in my view, is really the act of keeping all of that up to date." The cost of not consolidating is enumerable — heterogeneous refresh cadences, per-field volatility, fan-out to many destinations, "failures that are happening all the time," and a race where a record written to the CRM is not yet actionable in the sequencer. That list is a fair statement of what a governed single store buys you, and of why the choice is usually decided by organizational reach rather than by architecture. ([Berry](../sources/20260826_UhCY231d0FQ.md), 06:19-08:55)
...
- [GTM Engineering: The Technical Bits — Everett Berry, Clay](../sources/20260826_UhCY231d0FQ.md), 06:19-08:55
