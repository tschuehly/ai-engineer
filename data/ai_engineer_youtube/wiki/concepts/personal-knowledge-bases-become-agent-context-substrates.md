...
- **The organizational scale-up of the same idea, with the format chosen for two readers at once.** Notion's GTM context layer is "built off of plain markdown, a language that agents are fluent in," plus "databases and hierarchies that they can navigate easily," while remaining "well designed for humans" — which is what lets engineers, agents, and go-to-market staff "work off the same context" rather than each reading a private representation. ([Liu](../sources/20260826_L4I7WgiEquo.md), 18:18-18:44)
...
- [AI in GTM at Notion — Flora Liu](../sources/20260826_L4I7WgiEquo.md), 18:18-18:44
