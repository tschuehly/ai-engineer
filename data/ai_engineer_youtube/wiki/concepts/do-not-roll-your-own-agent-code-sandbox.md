...
- **A second axis the buy-versus-build framing hides: who operates the sandbox.** Warp shipped managed sandboxes first as "a really easy on-ramp… You didn't have to think about where your compute lived," then added self-hosting because "for teams doing serious work, they're probably managing their own infrastructure. They probably have dev boxes that they need to interact with… You really need to be able to run agent workloads on infrastructure that people bring so it adapts to their security concerns, their deployment practices, their workflows." Nothing in that objection is about isolation technology, so a platform that answers it with "our sandbox is hardened, don't build your own" is answering a different question. Buying the isolation and running it in the customer's account are compatible; conflating them costs you the deal and, in the other direction, tempts a team into writing a sandbox when what they needed was a deployment target. See [Ship Managed and Self-Hosted Sandboxes Because Serious Teams Bring Their Own Infrastructure](ship-managed-and-self-hosted-sandboxes-because-serious-teams-bring-their-own-infrastructure.md). ([Abdalla](../sources/20260822_L173Z8DpaJg.md), 04:12-05:07)
...
- [The Agent Behind the Curtain: Building the Oz Cloud Agent Platform — Safia Abdalla, Warp](../sources/20260822_L173Z8DpaJg.md), 04:12-05:07
