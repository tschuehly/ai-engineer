...
- **The same work-unit pattern outside a repository, for a business process.** Notion's signal service "emits a concrete task" that "could be for a human or an agent" and lands in the assignee's own database, carrying its pre-researched artifacts — the drafted email is attached before the human opens it. The durable unit is a database row rather than a versioned file, and the shared substrate is markdown plus databases "that agents can navigate easily" while remaining designed for humans. ([Liu](../sources/20260826_L4I7WgiEquo.md), 12:09-12:27, 16:14-16:41, 18:18-18:44)
...
- [AI in GTM at Notion — Flora Liu](../sources/20260826_L4I7WgiEquo.md), 12:09-12:27, 16:14-16:41, 18:18-18:44
