...
- **A blunt operational definition of self-service, from a team that had become the queue.** "The overall idea was to build something which is as self-served as possible so that people aren't always necessarily blocked by our team helping them out," and the specific friction being removed is "the back and forth with an engineering team." The test is not whether an API exists but whether a request still ends up in the platform team's backlog — which makes the platform team's own interrupt volume the metric, not the feature list. ([AI Evals for Cross-Functional Teams — Nachiket Paranjape & Swaroop Chitlur Haridas, DoorDash](../sources/20260828_bMjlRrWjdT0.md), 11:35-11:47, 13:23-13:36)
- **The precondition that makes self-service safe, and the demand that makes it valuable.** Izmit's platform lets business users deploy agents "without writing a single line of code" with the chat UI included, and the reason that is not reckless is that authorization is not theirs to get right: because all first-party, third-party, CRM, and call-transcript data lands in one store, "these agents can basically inherit a lot of the role-based access controls," with platform-level curation of reachable data sources on top. The demand side is organizational: these teams were previously "always in the backlog of someone, backlog of an IT team, or trying to get a SaaS budget," so the self-service surface removes a queue rather than a technical limitation. ([Building GTM AI Agents: Lessons from Deploying to 6,000 Users — Sait Izmit, Snowflake](../sources/20260826_DrTdD-ttjCY.md), 10:27-11:01, 19:26-20:19)
...
- [AI Evals for Cross-Functional Teams — Nachiket Paranjape & Swaroop Chitlur Haridas, DoorDash](../sources/20260828_bMjlRrWjdT0.md), 11:35-11:47, 13:23-13:36
- [Building GTM AI Agents: Lessons from Deploying to 6,000 Users — Sait Izmit, Snowflake](../sources/20260826_DrTdD-ttjCY.md), 10:27-11:01, 19:26-20:19
