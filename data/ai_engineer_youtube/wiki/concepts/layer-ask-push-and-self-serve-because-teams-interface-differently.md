...
- **The same layering question for external buyers resolves into an ordering, not a set.** Inside a company all three surfaces coexist because different people prefer different modes. Rosenthal's account of selling to organizations adds a sequencing constraint the internal case does not have: ship self-serve first, read what it fails to cover, then build the higher-touch tier from that evidence, then hire the humans to run it — because the reverse order specifies the high-touch product from whoever was loud enough to reach you, and the self-serve tier then competes with your own reps. Externally the layers are not merely different doors; the cheapest one is also the instrument that tells you what the expensive ones should contain. See [Ship Self-Serve Before the Enterprise Tier](ship-self-serve-before-the-enterprise-tier.md). ([Rosenthal](../sources/20260826_wdTRsfw0KG0.md), 02:25-04:14)
...
- [Reverse-Engineering the AI Buyer — Aliisa Rosenthal, Acrew Capital](../sources/20260826_wdTRsfw0KG0.md), 02:25-04:14
