...
- **The coverage argument stated as a property of the failure space rather than of the suite.** "The ways that a real system goes wrong are effectively unbounded, and synthetic test cases only cover the failures you already imagined. The ones that hurt you are often the ones that you didn't. And you'll only find those in real outputs." The charge against synthetic data here is not realism but provenance — it is a projection of the author's hypothesis space, so scaling it up scales the same coverage. The proposed remedy narrows the gap continuously rather than closing it: cluster real production outputs, name what surfaces, and feed new modes back into what gets reviewed and retrieved. It inherits the same limit one level down, since discovery only names what appeared in outputs somebody looked at. See [Discover Failure Modes From Production Outputs, Not Synthetic Cases](discover-failure-modes-from-production-outputs-not-synthetic-cases.md). ([Fox](../sources/20260822_yqF6XhzbWBk.md), 14:01-14:39, 15:39-15:59)
...
- [Inside 847 Production Clinical AI Notes — Sebastian Fox, Composo](../sources/20260822_yqF6XhzbWBk.md), 14:01-14:39, 15:39-15:59
